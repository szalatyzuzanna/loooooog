...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			video.className = "picking_picture";
	...
	getSWFHTML: function() {
		...
		if (!this.swfURL) {
			...
			if (base_url) this.swfURL = base_url + '/hr_attendance_webcam/static/src/js/webcam.swf';
			else this.swfURL = '/hr_attendance_webcam/static/src/js/webcam.swf';
		}
