...
odoo.define('inventory_log.canvas', function (require) {
    "use strict";
    ...
    // add publish objects od encapsulation to Odoo encapsulation
    // core.action_registry.add('borrow_kiosk_mode', Borrow);
    return CanvasSign;
    });
